...
$$
\begin{align}
RSS(\theta)&= \sum_{i=1}^{N_u}n_i\left(\frac{1}{n_i}\sum_{j=1}^{n_i}y_{ij}^2-2f_\theta(x_i)\bar{y}_i+f_\theta(x_i)^2\right)\\
&= \sum_{i=1}^{N_u}n_i\left(\bar{y}_i^2-2f_\theta(x_i)\bar{y}_i+f_\theta(x_i)^2\right)+\sum_{i=1}^{N_u}\sum_{j=1}^{n_i}y_{ij}^2-\sum_{i=1}^{N_u}{n_i\bar{y}_i^2}\\
&= \sum_{i=1}^{N_u}n_i\left(\bar{y}_i-f_\theta(x_i)\right)^2+\sum_{i=1}^{N_u}\sum_{j=1}^{n_i}y_{ij}^2-\sum_{i=1}^{N_u}{n_i\bar{y}_i^2}
\label{eq4}
\end{align}
$$
...
$$
\begin{equation}
RSS(\theta)=\sum_{i=1}^{N_u}n_i\left(\bar{y}_i-f_\theta(x_i)\right)^2
\end{equation}
\label{eq5}
$$
